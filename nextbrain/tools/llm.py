...
def get_client():
    ...
    from nextbrain.config import get_openai_api_key, get_openai_base_url
...
def get_model() -> str:
    from nextbrain.config import get_model as _get_model
    return _get_model()
...
def call_llm(
    ...
    """
    if _is_browser_mode():
        from nextbrain.tools.browser_llm import call_llm_browser
